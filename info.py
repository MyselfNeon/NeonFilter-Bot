...
PICS = (environ.get('PICS', 'https://envs.sh/hSI.jpg https://envs.sh/hS1.jpg https://envs.sh/hSz.jpg https://envs.sh/hSK.jpg https://envs.sh/hSs.jpg https://envs.sh/hSN.jpg https://envs.sh/hSv.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002627138181').split()]  # For Multiple Id Use One Space Between Each.
...
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b><i><blockquote>💲 Available Plans -</blockquote> \n\n• 30Rs - 01 Week\n• 50Rs - 01 Month\n• 120Rs - 03 Months\n• 220Rs - 06 Months\n\n<blockquote>🎁 Premium Features 🎁</blockquote>\n\n• No need to verify\n• No need to open links\n• Direct Files\n• Ad-free experience\n• High Speed download\n• Multiplayer streaming links\n• Unlimited Movies, Animes & Series\n• 24×7 Admin Support\n• Any request will be completed within 01 hour if available\n\n✨ Upi ID - <code>demo@okxyz</code>\n\nClick /myplan to check your plan 🍿\n\n💢 Must send screenshot after payment\n\n‼️ After sending screenshot please give us some time to add you in the Premium</i></b>')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/neonfileschat')
