    ...
    try:
        ...
        try:
            ...
            if mime == "video":
                ...
                markup = InlineKeyboardMarkup(
                    [[InlineKeyboardButton("📁 Document", callback_data="upload_document")]])
            await message.reply_text(f"<blockquote>**‣ 𝕊𝕖𝕝𝕖𝕔𝕥 𝕆𝕦𝕥𝕡𝕦𝕥 𝔽𝕚𝕝𝕖 𝕥𝕪𝕡𝕖** 📤</blockquote>\n\n**<blockquote>‣ ℕ𝕖𝕨 ℕ𝕒𝕞𝕖** 🎞</blockquote>\n```{out_filename}```", reply_to_message_id=msg.id, reply_markup=markup)
            ...
            if mime == "video":
                ...
                markup = InlineKeyboardMarkup(
                    [[InlineKeyboardButton("📁 Document", callback_data="upload_document")]])
            await message.reply_text(f"<blockquote>**‣ 𝕊𝕖𝕝𝕖𝕔𝕥 𝕆𝕦𝕥𝕡𝕦𝕥 𝔽𝕚𝕝𝕖 𝕥𝕪𝕡𝕖 📤**</blockquote>\n\n<blockquote>**‣ ℕ𝕖𝕨 ℕ𝕒𝕞𝕖 🎞️**</blockquote>\n{out_filename}", reply_to_message_id=msg.id, reply_markup=markup)
